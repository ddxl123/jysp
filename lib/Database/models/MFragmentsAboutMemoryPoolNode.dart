...
class MFragmentsAboutMemoryPoolNode implements MBase{
  ...
  MFragmentsAboutMemoryPoolNode.createModel({required int? atid_v,required String? uuid_v,required int? fragments_about_pending_pool_node_atid_v,required String? fragments_about_pending_pool_node_uuid_v,required int? using_raw_rule_atid_v,required String? using_raw_rule_uuid_v,required int? pn_memory_pool_node_atid_v,required String? pn_memory_pool_node_uuid_v,required int? created_at_v,required int? updated_at_v,}) {
  ...
  static Map<String, Object?> asJsonNoId({required int? atid_v,required String? uuid_v,required int? fragments_about_pending_pool_node_atid_v,required String? fragments_about_pending_pool_node_uuid_v,required int? using_raw_rule_atid_v,required String? using_raw_rule_uuid_v,required int? pn_memory_pool_node_atid_v,required String? pn_memory_pool_node_uuid_v,required int? created_at_v,required int? updated_at_v,}
  ) {
  ...
  /// 若 [byId] 为 null，则 query 的是全部 row。
  static Future<List<MFragmentsAboutMemoryPoolNode>> queryRowsAsModels([int? byId]) async {
