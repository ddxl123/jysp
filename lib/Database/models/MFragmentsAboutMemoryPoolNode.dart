...
class MFragmentsAboutMemoryPoolNode {
  ...
  static Map<String, Object?> toModelMap(Map<String, Object?> sqliteMap) {
    return {fragments_about_memory_pool_node_id:sqliteMap[fragments_about_memory_pool_node_id],fragments_about_memory_pool_node_uuid:sqliteMap[fragments_about_memory_pool_node_uuid],fragments_about_pending_pool_node_id:sqliteMap[fragments_about_pending_pool_node_id],fragments_about_pending_pool_node_uuid:sqliteMap[fragments_about_pending_pool_node_uuid],using_raw_rule_id:sqliteMap[using_raw_rule_id],using_raw_rule_uuid:sqliteMap[using_raw_rule_uuid],pn_memory_pool_node_id:sqliteMap[pn_memory_pool_node_id],pn_memory_pool_node_uuid:sqliteMap[pn_memory_pool_node_uuid],created_at:sqliteMap[created_at],updated_at:sqliteMap[updated_at],curd_status:sqliteMap[curd_status],};
  }
