...
class MRule implements MBase{
  ...
  /// 若 [where]/[whereArgs] 为 null，则 query 的是全部 row。
  static Future<List<MRule>> queryRowsAsModels({String? where, List<Object?>? whereArgs}) async {
  ...
  'raw_rule_aiid': null,
  'raw_rule_uuid': null,
  'pn_rule_pool_node_aiid': 'pn_rule_pool_nodes',
  ...
  final List<String> _deleteFatherFollowChildKeys =<String>[pn_rule_pool_node_aiid,pn_rule_pool_node_uuid,];
