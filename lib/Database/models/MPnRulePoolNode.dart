...
class MPnRulePoolNode {
  ...
  MPnRulePoolNode.createModel({required int? pn_rule_pool_node_id_v,required String? pn_rule_pool_node_uuid_v,required int? type_v,required String? name_v,required String? position_v,required int? created_at_v,required int? updated_at_v,required int? curd_status_v,}) {
    _rowModel.addAll({pn_rule_pool_node_id:pn_rule_pool_node_id_v,pn_rule_pool_node_uuid:pn_rule_pool_node_uuid_v,type:type_v,name:name_v,position:position_v,created_at:created_at_v,updated_at:updated_at_v,curd_status:curd_status_v,});
  }
  ...
  static Map<String, Object?> toSqliteMap({required int? pn_rule_pool_node_id_v,required String? pn_rule_pool_node_uuid_v,required int? type_v,required String? name_v,required String? position_v,required int? created_at_v,required int? updated_at_v,required int? curd_status_v,}
  ) {
  ...
  static Map<String, Object?> toModelMap(Map<String, Object?> sqliteMap) {
    return {pn_rule_pool_node_id:sqliteMap[pn_rule_pool_node_id],pn_rule_pool_node_uuid:sqliteMap[pn_rule_pool_node_uuid],type:sqliteMap[type],name:sqliteMap[name],position:sqliteMap[position],created_at:sqliteMap[created_at],updated_at:sqliteMap[updated_at],curd_status:sqliteMap[curd_status],};
  }
