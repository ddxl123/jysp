...
class MUpload implements MBase{
  ...
  /// 若 [where]/[whereArgs] 为 null，则 query 的是全部 row。
  static Future<List<MUpload>> queryRowsAsModels({String? where, List<Object?>? whereArgs}) async {
  ...
  final Set<String> _deleteChildFollowFatherKeysForSingle = <String>{'row_id',};
