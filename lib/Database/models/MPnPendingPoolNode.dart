...
class MPnPendingPoolNode implements MBase{
  ...
  MPnPendingPoolNode.createModel({required int? aiid_v,required String? uuid_v,required int? recommend_raw_rule_aiid_v,required String? recommend_raw_rule_uuid_v,required PendingPoolNodeType? type_v,required String? name_v,required String? position_v,required int? created_at_v,required int? updated_at_v,}) {
    _rowJson.addAll(<String, Object?>{aiid:aiid_v,uuid:uuid_v,recommend_raw_rule_aiid:recommend_raw_rule_aiid_v,recommend_raw_rule_uuid:recommend_raw_rule_uuid_v,type:type_v?.index,name:name_v,position:position_v,created_at:created_at_v,updated_at:updated_at_v,});
  }
  ...
  static Map<String, Object?> asJsonNoId({required int? aiid_v,required String? uuid_v,required int? recommend_raw_rule_aiid_v,required String? recommend_raw_rule_uuid_v,required PendingPoolNodeType? type_v,required String? name_v,required String? position_v,required int? created_at_v,required int? updated_at_v,}
  ) {
    return <String, Object?>{aiid:aiid_v,uuid:uuid_v,recommend_raw_rule_aiid:recommend_raw_rule_aiid_v,recommend_raw_rule_uuid:recommend_raw_rule_uuid_v,type:type_v?.index,name:name_v,position:position_v,created_at:created_at_v,updated_at:updated_at_v,};
  }

  static Map<String, Object?> asModelNoId(Map<String, Object?> json) {
    return <String, Object?>{aiid:json[aiid],uuid:json[uuid],recommend_raw_rule_aiid:json[recommend_raw_rule_aiid],recommend_raw_rule_uuid:json[recommend_raw_rule_uuid],type:json[type] == null ? null : PendingPoolNodeType.values[json[type]! as int],name:json[name],position:json[position],created_at:json[created_at],updated_at:json[updated_at],};
  }
  ...
  /// 若 [where]/[whereArgs] 为 null，则 query 的是全部 row。
  static Future<List<MPnPendingPoolNode>> queryRowsAsModels({required String? where,required List<Object?>? whereArgs,required Transaction? connectTransaction}) async {
  ...
  @override
  String? getForeignKeyBelongsTos({required String foreignKeyName}) => <String,String?>{recommend_raw_rule_aiid: 'rules.aiid',recommend_raw_rule_uuid: 'rules.uuid',}[foreignKeyName];
