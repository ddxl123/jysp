...
class MToken implements DBTableBase {
  ...
  @override
  Map<String, List<SqliteType>> get fields => {access_token: [SqliteType.TEXT], refresh_token: [SqliteType.TEXT], created_at: [SqliteType.INTEGER, SqliteType.UNSIGNED, SqliteType.NOT_NULL], updated_at: [SqliteType.INTEGER, SqliteType.UNSIGNED, SqliteType.NOT_NULL]};

  static Map<String, dynamic> toMap({required String access_token_v,required String refresh_token_v,required int created_at_v,required int updated_at_v,}
  ) {
