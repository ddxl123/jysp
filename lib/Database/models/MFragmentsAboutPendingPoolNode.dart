...
class MFragmentsAboutPendingPoolNode implements MBase{
  ...
  MFragmentsAboutPendingPoolNode.createModel({required int? aiid_v,required String? uuid_v,required int? raw_fragment_aiid_v,required String? raw_fragment_uuid_v,required int? pn_pending_pool_node_aiid_v,required String? pn_pending_pool_node_uuid_v,required int? recommend_rule_aiid_v,required String? recommend_rule_uuid_v,required String? title_v,required int? created_at_v,required int? updated_at_v,}) {
    getRowJson.addAll(<String, Object?>{aiid:aiid_v,uuid:uuid_v,raw_fragment_aiid:raw_fragment_aiid_v,raw_fragment_uuid:raw_fragment_uuid_v,pn_pending_pool_node_aiid:pn_pending_pool_node_aiid_v,pn_pending_pool_node_uuid:pn_pending_pool_node_uuid_v,recommend_rule_aiid:recommend_rule_aiid_v,recommend_rule_uuid:recommend_rule_uuid_v,title:title_v,created_at:created_at_v,updated_at:updated_at_v,});
  }
  ...
  static Map<String, Object?> asJsonNoId({required int? aiid_v,required String? uuid_v,required int? raw_fragment_aiid_v,required String? raw_fragment_uuid_v,required int? pn_pending_pool_node_aiid_v,required String? pn_pending_pool_node_uuid_v,required int? recommend_rule_aiid_v,required String? recommend_rule_uuid_v,required String? title_v,required int? created_at_v,required int? updated_at_v,}
  ) {
  ...
  static Map<String, Object?> asModelNoId(Map<String, Object?> json) {
    return <String, Object?>{aiid:json[aiid],uuid:json[uuid],raw_fragment_aiid:json[raw_fragment_aiid],raw_fragment_uuid:json[raw_fragment_uuid],pn_pending_pool_node_aiid:json[pn_pending_pool_node_aiid],pn_pending_pool_node_uuid:json[pn_pending_pool_node_uuid],recommend_rule_aiid:json[recommend_rule_aiid],recommend_rule_uuid:json[recommend_rule_uuid],title:json[title],created_at:json[created_at],updated_at:json[updated_at],};
  }
  ...
  @override
  String? getForeignKeyBelongsTos({required String foreignKeyName}) => <String,String?>{raw_fragment_aiid: null,raw_fragment_uuid: null,pn_pending_pool_node_aiid: 'pn_pending_pool_nodes.aiid',pn_pending_pool_node_uuid: 'pn_pending_pool_nodes.uuid',recommend_rule_aiid: 'fragments_about_rule_pool_nodes.aiid',recommend_rule_uuid: 'fragments_about_rule_pool_nodes.uuid',}[foreignKeyName];
