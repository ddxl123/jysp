...
class MFragmentsAboutCompletePoolNode implements MBase{
  ...
  /// 若 [where]/[whereArgs] 为 null，则 query 的是全部 row。
  static Future<List<MFragmentsAboutCompletePoolNode>> queryRowsAsModels({required String? where,required List<Object?>? whereArgs,required Transaction? connectTransaction}) async {
