...
@override int? get get_id => getRowJson[id] as int?;@override int? get get_aiid => getRowJson[aiid] as int?;@override String? get get_uuid => getRowJson[uuid] as String?; int? get get_fragments_about_pending_pool_node_aiid => getRowJson[fragments_about_pending_pool_node_aiid] as int?; String? get get_fragments_about_pending_pool_node_uuid => getRowJson[fragments_about_pending_pool_node_uuid] as String?; int? get get_used_raw_rule_aiid => getRowJson[used_raw_rule_aiid] as int?; String? get get_used_raw_rule_uuid => getRowJson[used_raw_rule_uuid] as String?; int? get get_pn_complete_pool_node_aiid => getRowJson[pn_complete_pool_node_aiid] as int?; String? get get_pn_complete_pool_node_uuid => getRowJson[pn_complete_pool_node_uuid] as String?;@override int? get get_created_at => getRowJson[created_at] as int?;@override int? get get_updated_at => getRowJson[updated_at] as int?;
}
