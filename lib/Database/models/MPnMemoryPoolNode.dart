...
class MPnMemoryPoolNode implements MBase{
  ...
  MPnMemoryPoolNode.createModel({required int? atid_v,required String? uuid_v,required int? using_raw_rule_atid_v,required String? using_raw_rule_uuid_v,required MemoryPoolNodeType? type_v,required String? name_v,required String? position_v,required int? created_at_v,required int? updated_at_v,}) {
    _rowJson.addAll(<String, Object?>{atid:atid_v,uuid:uuid_v,using_raw_rule_atid:using_raw_rule_atid_v,using_raw_rule_uuid:using_raw_rule_uuid_v,type:type_v?.index,name:name_v,position:position_v,created_at:created_at_v,updated_at:updated_at_v,});
  }
  ...
  static Map<String, Object?> asJsonNoId({required int? atid_v,required String? uuid_v,required int? using_raw_rule_atid_v,required String? using_raw_rule_uuid_v,required MemoryPoolNodeType? type_v,required String? name_v,required String? position_v,required int? created_at_v,required int? updated_at_v,}
  ) {
    return <String, Object?>{atid:atid_v,uuid:uuid_v,using_raw_rule_atid:using_raw_rule_atid_v,using_raw_rule_uuid:using_raw_rule_uuid_v,type:type_v?.index,name:name_v,position:position_v,created_at:created_at_v,updated_at:updated_at_v,};
  }

  static Map<String, Object?> asModelNoId(Map<String, Object?> json) {
    return <String, Object?>{atid:json[atid],uuid:json[uuid],using_raw_rule_atid:json[using_raw_rule_atid],using_raw_rule_uuid:json[using_raw_rule_uuid],type:json[type] == null ? null : MemoryPoolNodeType.values[json[type]! as int],name:json[name],position:json[position],created_at:json[created_at],updated_at:json[updated_at],};
  }
  ...
  /// 若 [byId] 为 null，则 query 的是全部 row。
  static Future<List<MPnMemoryPoolNode>> queryRowsAsModels([int? byId]) async {
