...
class MPnMemoryPoolNode {
  ...
  MPnMemoryPoolNode.createModel({required int? pn_memory_pool_node_id_v,required String? pn_memory_pool_node_uuid_v,required int? using_raw_rule_id_v,required String? using_raw_rule_uuid_v,required int? type_v,required String? name_v,required String? position_v,required int? created_at_v,required int? updated_at_v,required Curd? curd_status_v,}) {
    _rowModel.addAll({pn_memory_pool_node_id:pn_memory_pool_node_id_v,pn_memory_pool_node_uuid:pn_memory_pool_node_uuid_v,using_raw_rule_id:using_raw_rule_id_v,using_raw_rule_uuid:using_raw_rule_uuid_v,type:type_v,name:name_v,position:position_v,created_at:created_at_v,updated_at:updated_at_v,curd_status:curd_status_v?.index,});
  }
  ...
  static Map<String, Object?> toSqliteMap({required int? pn_memory_pool_node_id_v,required String? pn_memory_pool_node_uuid_v,required int? using_raw_rule_id_v,required String? using_raw_rule_uuid_v,required int? type_v,required String? name_v,required String? position_v,required int? created_at_v,required int? updated_at_v,required Curd? curd_status_v,}
  ) {
    return {pn_memory_pool_node_id:pn_memory_pool_node_id_v,pn_memory_pool_node_uuid:pn_memory_pool_node_uuid_v,using_raw_rule_id:using_raw_rule_id_v,using_raw_rule_uuid:using_raw_rule_uuid_v,type:type_v,name:name_v,position:position_v,created_at:created_at_v,updated_at:updated_at_v,curd_status:curd_status_v?.index,};
  }

  static Map<String, Object?> toModelMap(Map<String, Object?> sqliteMap) {
    return {pn_memory_pool_node_id:sqliteMap[pn_memory_pool_node_id],pn_memory_pool_node_uuid:sqliteMap[pn_memory_pool_node_uuid],using_raw_rule_id:sqliteMap[using_raw_rule_id],using_raw_rule_uuid:sqliteMap[using_raw_rule_uuid],type:sqliteMap[type],name:sqliteMap[name],position:sqliteMap[position],created_at:sqliteMap[created_at],updated_at:sqliteMap[updated_at],curd_status:sqliteMap[curd_status] == null ? null : Curd.values[sqliteMap[curd_status] as int],};
  }
