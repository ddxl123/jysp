...
class MPnMemoryPoolNode implements MBase{
  ...
  MPnMemoryPoolNode.createModel({required int? aiid_v,required String? uuid_v,required int? using_rule_aiid_v,required String? using_rule_uuid_v,required MemoryPoolNodeType? type_v,required String? name_v,required String? position_v,required int? created_at_v,required int? updated_at_v,}) {
    getRowJson.addAll(<String, Object?>{aiid:aiid_v,uuid:uuid_v,using_rule_aiid:using_rule_aiid_v,using_rule_uuid:using_rule_uuid_v,type:type_v?.index,name:name_v,position:position_v,created_at:created_at_v,updated_at:updated_at_v,});
  }
  ...
  static Map<String, Object?> asJsonNoId({required int? aiid_v,required String? uuid_v,required int? using_rule_aiid_v,required String? using_rule_uuid_v,required MemoryPoolNodeType? type_v,required String? name_v,required String? position_v,required int? created_at_v,required int? updated_at_v,}
  ) {
    return <String, Object?>{aiid:aiid_v,uuid:uuid_v,using_rule_aiid:using_rule_aiid_v,using_rule_uuid:using_rule_uuid_v,type:type_v?.index,name:name_v,position:position_v,created_at:created_at_v,updated_at:updated_at_v,};
  }

  static Map<String, Object?> asModelNoId(Map<String, Object?> json) {
    return <String, Object?>{aiid:json[aiid],uuid:json[uuid],using_rule_aiid:json[using_rule_aiid],using_rule_uuid:json[using_rule_uuid],type:json[type] == null ? null : MemoryPoolNodeType.values[json[type]! as int],name:json[name],position:json[position],created_at:json[created_at],updated_at:json[updated_at],};
  }
