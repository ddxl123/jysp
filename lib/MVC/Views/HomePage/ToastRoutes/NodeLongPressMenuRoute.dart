...
//   NodeLongPressMenuRoute(BuildContext fatherContext, {required this.poolNodeMModel}) : super(fatherContext);
...
//                   showToastRoute(context, NodeRenameRoute(fatherContext, poolNodeMModel: poolNodeMModel));
//                 },
//               ),
//               TextButton(
...
//           } else if (result == 0) {
//             final bool isOk = await RSqliteCurd<MBase>.byModel(poolNodeMModel.model).toDeleteRow(connectTransaction: null);
//             if (isOk) {
//               fatherContext.read<FragmentPoolController>().getPoolTypeNodesList().remove(poolNodeMModel);
